...
class FranchiseDAOTest {
    ...
    void getAllByCart() {
        ...
        Franchise item1 = new Franchise("name_1", "code_1", 10, 1);
        Franchise item2 = new Franchise("name_2", "code_2", 20, 2);
        Franchise savedItem1 = itemDAO.saveAndFlush(item1);
        Franchise savedItem2 = itemDAO.saveAndFlush(item2);
        ...
        List<Franchise> foundItems = itemDAO.getAllByCart(savedCart1.getId());
    ...
    void getAllAvailable() {
        Franchise item1 = new Franchise("name_1", "code_1", 10, 10);
        Franchise item2 = new Franchise("name_2", "code_2", 20, 0);
        Franchise savedItem1 = itemDAO.saveAndFlush(item1);
        Franchise savedItem2 = itemDAO.saveAndFlush(item2);
        items.add(savedItem1);
        items.add(savedItem2);

        List<Franchise> foundItems = itemDAO.getAllAvailable();
        assertNotNull(foundItems);
        assertTrue(!foundItems.isEmpty());
        assertTrue(foundItems.size() == 1);
        assertEquals(foundItems.get(0).getId(), savedItem1.getId());
